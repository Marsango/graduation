...
int triangular(Spa_Mat* matrizes, int l, int c){
    for (int i = 0; i < l; i++){
        if(buscar_pos(i, i, matrizes) == 0){
            return 0;
        }
    }
   if(buscar_pos(1, 0, matrizes) != 0){
     for (int i = 0; i < l; i++){
        for(int j = 0; j < i; j++){
         if(buscar_pos(i, j, matrizes) == 0){
            return 0;
        }
        }
    }
    ...
    else if(buscar_pos(0, 1, matrizes) != 0){
     for (int i = 0; i < l; i++){
        for(int j = 0; j < i; j++){
         if(buscar_pos(i, j, matrizes) != 0){
            return 0;
...
int main() {
    ...
    for (int i = 0; i < l; i++){
        for(int j = 0; j < c; j++){
            trocar(mat[i][j], i, j, matrizes);
        }
    }
    if(triangular(matrizes, l, c) == 1){
        printf("triangular");
    }
    else{
